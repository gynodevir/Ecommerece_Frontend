  ...
  return (
    <div className='border rounded-lg shadow-xl overflow-hidden transition-shadow duration-300 '>
      ...
      <div className='p-4 '>
        ...
        onClick={()=>{}}
        className={`bg-blue-500 ${isAvilable ? "opacity-100 hover:bg-blue-600" : "opacity-70"}
        text-white py-2 px-3 rounded-lg items-center transition-colors duration-300  w-26 flex justify-center`}>
          <FaShoppingCart className='mr-2'/>
          {isAvilable?"Add to Cart" : "Stock Out"}
        </button>
        </div>
